...
ou've seen some of them used in the dow function, which returns the day of the week for a specific date.
...
hen it returns the value in the same format as it receives the date: "year-month-day".
...
def next_date(date_string):
    ...
    next_date_string = next_date_obj.strftime("%Y-%m-%d")  # Fix format codes
